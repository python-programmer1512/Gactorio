...
Memento 객체는 public field 구조체가 아니라 private field와 getter를 가진 class로 관리합니다.
...
이 Memento들은 public field를 직접 노출하지 않고, private field와 getter로 snapshot 값을 캡슐화합니다.
...
동적 라인 복원을 위해 nextLineId와 nextMachineId도 함께 저장한 뒤,
