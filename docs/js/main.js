...
import { Application }     from './Application.js?v=20260614-hotfix-layout2';
import { SimControlPanel } from './panels/SimControlPanel.js?v=20260614-hotfix-layout2';
import { FactoryPanel }    from './panels/FactoryPanel.js?v=20260614-hotfix-layout2';
import { ProductsPanel }   from './panels/ProductsPanel.js?v=20260614-hotfix-layout2';
import { EventLogPanel }   from './panels/EventLogPanel.js?v=20260614-hotfix-layout2';
import { InventoryPanel }  from './panels/InventoryPanel.js?v=20260614-hotfix-layout2';
import { RuntimeConfigPanel } from './panels/RuntimeConfigPanel.js?v=20260614-hotfix-layout2';
import { InspectorPanel }  from './panels/InspectorPanel.js?v=20260614-hotfix-layout2';

console.log('[gactorio] main.js loaded - build', '2026-06-14-hotfix-layout2');
